...
from .global_modules.output import OutputMapsFactory
...
class LisfloodModel_dyn(DynamicModel):
    ...
    def dynamic(self):
        ...
        # Re initializing the all the output maps
        if self.TimeSinceStart == 1 and settings.mc_set and settings.enkf_set:
